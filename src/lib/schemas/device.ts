...
export const deviceSchema = z.object({
  ...
  name: z
    ...
    .max(128, 'Hostname must be 128 characters or fewer'),
  serialNumber: z
    .string()
    .min(1, 'Serial number is required')
    .max(128, 'Serial number must be 128 characters or fewer'),
  ...
  vendor: z
    ...
    .max(128, 'Vendor must be 128 characters or fewer'),
  ...
  heightU: z
    ...
    .max(60, 'Height must be 60U or fewer'),
  deviceStackName: z
    .string()
    .max(128, 'Stack name must be 128 characters or fewer')
    .optional()
    .nullable(),
  ...
  stackMember: z
    ...
    .positive('Member number must be a positive integer')
    .max(32, 'Member number must be 32 or fewer')
    .optional()
    .nullable(),
})
