export function LegacyEndpointSummarySkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy endpoint summary" className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
...
export function LegacyEndpointFiltersSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy endpoint filters" className="flex flex-wrap gap-2">
...
export function LegacyEndpointResultsSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy endpoint results" className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
