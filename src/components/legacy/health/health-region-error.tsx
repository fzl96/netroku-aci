...
export function LegacyHealthRegionError({ region }: { region: 'summary' | 'filters' | 'results' }) {
  ...
  return (
    ...
    >
      <div>
        <p className="text-sm font-medium text-foreground">Could not load legacy health {region}</p>
