export function LegacyDeviceSummarySkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy device summary" className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
...
export function LegacyDeviceFiltersSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy device filters" className="flex flex-col gap-2 sm:flex-row sm:items-center">
...
export function LegacyDeviceResultsSkeleton() {
  return (
    <div aria-busy="true" aria-label="Loading legacy device results" className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
