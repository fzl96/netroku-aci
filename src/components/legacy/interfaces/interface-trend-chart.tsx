...
export function LegacyInterfaceTrendChart({ points }: { points: LegacyInterfaceSampleView[] }) {
  ...
  if (chartPoints.length === 0)
    return (
      <div className="grid h-48 place-items-center rounded-xl border border-dashed border-border text-xs text-subtle">
