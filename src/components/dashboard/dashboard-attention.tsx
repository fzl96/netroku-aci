...
import { dashboardToneSurfaceClass, formatDashboardNumber } from './dashboard-presenters'
      ...
      {attentionItems.length > 0 ? (
        <div className="mt-4 divide-y divide-border">
          {attentionItems.map((item) => (
            ...
            >
              <span
                className={`flex size-10 shrink-0 items-center justify-center rounded-lg border text-sm font-semibold ${dashboardToneSurfaceClass(item.tone)}`}
              >
