...
export function EpgPortDetailPanel({
  ...
  return (
    <>
      ...
      <aside className="animate-panel-in fixed top-0 right-0 z-30 flex h-full w-[720px] max-w-full flex-col border-l border-border bg-card shadow-2xl">
        <div className="px-6 py-5 border-b border-subtle flex items-start justify-between shrink-0 gap-4">
          <div className="min-w-0 flex-1">
            <h2 className="font-serif text-base font-semibold text-foreground truncate" title={`Node ${port.node} / Port ${port.port}`}>
